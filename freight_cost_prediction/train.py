# ## if we use ml pipeline line airflow , mlops then we can see this whole train.py file in the flow chart as  a pipeline means whole flow after which what comes 
...
# def main():
#     db_path = "C:/machine_learning_invoice_intelligent_project/data/inventory.db"
...
def main():
    ...
    print("Training columns:", X.columns.tolist())  # ✅ debug
